...
public class Main {
    public static void main( String args[] ) {
        ...
        try {
            ...
            // first put each country and their population from StatService into the hashmap
            ...
            // then put each country and their population from Database into the hashmap
